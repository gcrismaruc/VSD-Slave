...
//import com.jogamp.opengl.util.glsl.shaders.ShaderProgram;
...
//
//        program = new Program(gl, getClass(), "shaders", "hello-triangle", "hello-triangle");
//
...
//                    "frag", null, true);
//
//            shaders.ShaderProgram shaderProgram = new shaders.ShaderProgram();
//
