...
public class MeshObjectLoader {
    ...
    public static MeshArrays loadModelMeshFromStream(InputStream is) {
        ...
        try {
            ...
            if (ENABLE_LOGGING) {
                System.out.println(TAG + "Vertices: " + numVerts);
                System.out.println(TAG + "Normals: " + numNormals);
                System.out.println(TAG + "TextureCoords: " + numTexCoords);
                System.out.println(TAG + "Faces: " + numFaces);
            }
